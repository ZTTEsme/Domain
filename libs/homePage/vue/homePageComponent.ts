          ...
          <div class="page-content">
              ...
              <div class="card me-3">
                <div class="card-body">
                  ...
                  <a :href="interactor.router.getFullUriOfRouteByName('company')" class="btn btn-primary w-100">{{model.labels.edit}}</a>
                </div>
              </div>
              <div class="card me-3">
                <div class="card-body">
                  ...
                  <a :href="interactor.router.getFullUriOfRouteByName('CompanySite')" class="btn btn-primary w-100">{{ model.labels.edit }}</a>
                </div>
              </div>
              <div class="card me-3">
                <div class="card-body">
                  ...
                  <a :href="interactor.router.getFullUriOfRouteByName('User')" class="btn btn-primary w-100">{{ model.labels.edit }}</a>
                </div>
              </div>
              </div>
          </div>
